...
<body>
	...
	<div style="text-align:center;"> 
		<img src="${contextPath}/img/glamping_main.jpg" style="width: 1880px; height:500px;"></img>
	</div>
<div class="container">
		<br><br><br><br><br>

		<div><span id="title">${glampingView.glampingBoard.GL_TITLE}</span></div>
					<div class="write_na">작성자: ${glampingView.glampingBoard.NICKNAME}
						<div style="display: inline-block; text-align: right; float: right;">
							<span style="margin-right: 180px;">조회 수: ${glampingView.glampingBoard.READCOUNT}</span>
						</div>
					</div>
						<div class="write_date">
							<fmt:parseDate var="parseRegDate" value="${glampingView.glampingBoard.WRITEDATE}" pattern="yyyy-mm-dd"/>
					...
					<div style="text-align: center; margin-right: 80px; margin-bottom: 15px;">
						<c:choose>
							<c:when test="${glampingView.liketo == 0}">
								...
								<br><span id="likeCount">${glampingView.likeCount}</span>
							</c:when>	
							<c:otherwise>		
								<a href="javascript:like_func();" class="checkHeart1"><span class="checkHeart">♥</span></a>
								<br><span id="likeCount">${glampingView.likeCount}</span>
	...
	<div style="text-align: center;">
		<span class="userNameText" style="font-size: 17px; font-weight: bold;">${nickName}</span>
			<form name="replyForm" id="replyForm">
				...
				<input type="submit" id="reply_btn" style="border: solid 1px #1f8dd6; background-color: #1f8dd6; width: 70px; height: 80px; color: white;" value="등록">
			</form>
		<br>
	</div>
